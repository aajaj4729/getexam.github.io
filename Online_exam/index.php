...
echo "<h1 class='text-center bg-danger'>Welcome to Online Exam</h1>";
  ...
  <tr>
    ...
    <td width="93%" valign="bottom" bordercolor="#0000FF"> <a href="sublist.php" class="style4"><h2>Subject for Quiz </h2></a></td>
  </tr>
  <tr>
    <td height="58" valign="bottom"><img src="image/DEGREE.JPG" width="43" height="43" align="absmiddle"></td>
    <td valign="bottom"> <a href="result.php" class="style4"><h2>Result</h2> </a></td>
  </tr>
</table>';
