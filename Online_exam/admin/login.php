...
else if(!isset($_SESSION[alogin]))
{
	echo "<BR><BR><BR><BR><div class=head1> Your are not logged in<br> Please <a href=index.php>Login</a><div>";
		...
		echo "<h3 class='text-center' >Here Admin can remove students and they can add, delete, and update etc questions. And they can also add remove and modify the subject of the examination.";	
